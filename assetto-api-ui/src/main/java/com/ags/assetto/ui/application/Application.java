package com.ags.assetto.ui.application;

import com.ags.assetto.ui.coffee.CoffeeServlet;
import com.ags.assetto.ui.thymeleaf.interceptor.ThymeleafLayoutInterceptor;
...
@ComponentScan(basePackages = {"com.ags.assetto"})
